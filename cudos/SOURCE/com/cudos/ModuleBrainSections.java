...
public class ModuleBrainSections extends CudosExhibit {
	final String filename="resources/index/Labels.txt";
  ...
  public ModuleBrainSections() {
	...
	public String getExhibitName(){return "Brain sections";}
  ...
  FlowLayout flowLayout1 = new FlowLayout();
	public void postinit(){
		...
		Font bigfont=new Font("SansSerif",Font.BOLD,8);
